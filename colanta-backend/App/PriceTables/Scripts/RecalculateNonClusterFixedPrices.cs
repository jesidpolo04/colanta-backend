...
namespace colanta_backend.App.PriceTables.Scripts{
    public class RecalculateNonClusterFixedPrices{
        ...
        public RecalculateNonClusterFixedPrices(
        ...
        public void Execute(){
            var promotions = _PromotionsRepository.getNonClusterActivePromotions();
            var count = 1;

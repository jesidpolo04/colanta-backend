namespace colanta_backend.App.Promotions.Infraestructure
{
    ...
    public class VtexPromotionCategory
    {
        public string id { get; set; }
        public string name { get; set; }
    }

    public class VtexPromotionBrand
    {
        public string id { get; set; }
        public string name { get; set; }
    }

    public class VtexPromotionProduct
    {
        public string id { get; set; }
        public string name { get; set; }
    }

    public class VtexPromotionSku
    {
        public string id { get; set; }
        public string name { get; set; }
    }

    public class VtexPromotionGifts
    {
        public int quantitySelectable { get; set; }
        public VtexPromotionGift[] gifts { get; set; }
    }

    public class VtexPromotionGift
    {
        public string id { get; set; }
        public string name { get; set; }
        public int quantity { get; set; }
        public object[] sellers { get; set; }
    }
